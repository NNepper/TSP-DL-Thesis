...
python $LOCALSCRATCH/$SLURM_JOB_ID/experimentation_Graph2Seq.py --enc_hid_dim 1024 --enc_num_heads 8  --num_nodes 50  --loss full --directory $LOCALSCRATCH/$SLURM_JOB_ID/result --data_train  $LOCALSCRATCH/$SLURM_JOB_ID/data/tsp50_train.txt --data_test $LOCALSCRATCH/$SLURM_JOB_ID/data/tsp50_test.txt --n_gpu 1
